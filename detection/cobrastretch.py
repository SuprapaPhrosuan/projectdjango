    ...
    async def receive(self, text_data):
        ...
        if frame_data:
            ...
            if results.pose_landmarks:
                ...
                right_ankle_angle = u.calculateAngle2(landmarks[point[32]],landmarks[point[28]],landmarks[point[26]])
                ...
                if distance_camera >= 200:
                    ...
                    if (10 <= right_shoulder_angle <= 70) and (200 <= right_hip_angle <= 280) and (160 <= right_knee_angle <= 200) and (145 <= right_ankle_angle <= 200):
                        label = 'Correct pose'
                        color = (0, 255, 0)
                    elif (10 <= right_shoulder_angle <= 70) and (200 <= right_hip_angle <= 280) and (160 <= right_knee_angle <= 200) and (right_ankle_angle < 145):
                        label = 'Straighten your feet !'
                        color = (0, 0, 255)
                    elif (10 <= right_shoulder_angle <= 70) and (200 <= right_hip_angle <= 280) and (right_knee_angle < 160) and (145 <= right_ankle_angle <= 200):
                        label = 'Make your legs tighter !'
                        color = (0, 0, 255)
                    elif (0 <= right_shoulder_angle <= 360) and (160 <= right_hip_angle <= 175) and (160 <= right_knee_angle <= 175) and (right_ankle_angle > 120):
                        label = 'Push your body up !'
                        color = (0, 0, 255)
                    elif (0 <= right_shoulder_angle <= 360) and (130 <= right_hip_angle < 200) and (right_knee_angle < 160) and (right_ankle_angle > 90):
                        label = 'Push your hip down'
                        color = (0, 0, 255)
                    else:
                        label = 'Unknown' 
                        color = (0, 0, 255)
