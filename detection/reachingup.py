        ...
        if frame_data:
            ...
            if results.pose_landmarks:
                ...
                if distance_camera >= 200:
                    ...
                    if (160 <= right_elbow_angle <= 195) and (160 <= right_shoulder_angle <= 195) :
                        label = 'Correct pose'
                        color = (0, 255, 0) 
                    elif (right_elbow_angle <= 360) and (right_shoulder_angle <= 360):       
                        label = 'Stretch arms overhead more !'
                        color = (0, 0, 255)
                    else:
                        label = 'Unknown' 
                        color = (0, 0, 255)
