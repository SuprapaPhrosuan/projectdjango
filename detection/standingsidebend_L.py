    ...
    async def receive(self, text_data):
        ...
        if frame_data:
            ...
            if results.pose_landmarks:
                ...
                right_hip_angle = u.calculateAngle2(landmarks[point[12]],landmarks[point[24]],landmarks[point[26]])
                ...
                if distance_camera >= 200:
                    ...
                    if (140 <= right_shoulder_angle <= 165) and (120 <right_hip_angle <= 165):
                        label = 'Correct pose'
                        color = (0, 255, 0)
                    elif (right_shoulder_angle <= 360) and (right_hip_angle <= 165 or 165 < right_hip_angle <= 360):
                        label = 'Stretch arms overhead to L !' 
                        color = (0, 0, 255)                            
                    else:
                        label = 'Unknown' 
                        color = (0, 0, 255)
