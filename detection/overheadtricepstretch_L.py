    ...
    async def receive(self, text_data):
        ...
        if frame_data:
            ...
            if results.pose_landmarks:
                ...
                right_shoulder_angle = u.calculateAngle(landmarks[point[24]],landmarks[point[12]],landmarks[point[14]])
                right_elbow_angle = u.calculateAngle(landmarks[point[16]],landmarks[point[14]],landmarks[point[12]])                
                ...
                if distance_camera >= 600:
                    ...
                    if (170 <= right_shoulder_angle <= 220 and right_elbow_angle < 140):
                        label = 'Correct pose'
                        color = (0, 255, 0)
                            
                    elif (right_shoulder_angle < 170 and right_elbow_angle < 140) or (right_shoulder_angle < 170 and right_elbow_angle >= 140):
                        label = 'Raise L-elbow & stretch overhead!'
                        color = (0, 0, 255)
